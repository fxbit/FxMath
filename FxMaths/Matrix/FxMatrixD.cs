...
namespace FxMaths.Matrix
{
    ...
    [Serializable]
    public partial class FxMatrixD : FxMatrix<double>
    {

        #region Constructors

        public FxMatrixD( int width, int height )
            : base( width, height )
        {
        ...
        public FxMatrixD(int width, int height, float value)
            : base( width, height )
        {
            // allocate the data array
            this.Data = new double[Size];
        ...
        protected override FxMatrix<double> AllocateMatrix()
        {
            return new FxMatrixD(Width, Height);
        }


        protected override FxMatrix<double> AllocateCopyMatrix()
        {
        ...
        protected override FxMatrix<double> AllocateMatrix( int _Width, int _Height )
        {
            return new FxMatrixD( _Width, _Height );
        }

        protected override Vector.FxVector<double> AllocateVector(int Size)
        {
            return new Vector.FxVectorD( Size );
        }
        ...
        /// </summary>
        /// <returns></returns>
        public new FxMatrixD Copy()
        {
            return AllocateCopyMatrix() as FxMatrixD;
        }
        #endregion
        ...
        public void SetValue(FxMatrixMask mask, double value)
        {
        ...
        public FxMatrixD this[FxMatrixMask mask]
        {
            get
            {
                FxMatrixD newMat = new FxMatrixD(Width, Height);
        ...
        protected override void DoAdd( FxMatrix<double> other, FxMatrix<double> result )
        {
            // pass all the data and add the new data
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected override void DoAdd( FxMatrix<double> other )
        {
            // pass all the data and add the new data
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected void Add(FxMatrix<double> other, FxMatrixMask mask)
        {
            // pass all the data and add the new data
            Parallel.For(0, Height, (y) =>
            {
        ...
        protected void DoAdd(double value, FxMatrixMask mask)
        {
            // pass all the data and add the value
            Parallel.For(0, Height, (y) =>
            {
        ...
        protected override void DoAddRow(FxMaths.Vector.FxVector<double> Row, int RowIndex)
        {
        ...
        protected override void DoAddCol(FxMaths.Vector.FxVector<double> Col, int ColIndex)
        {
            // pass all the data and add the value
        ...
        public void Add(int sx, int sy, FxMatrixD mat)
        {
        ...
        public static FxMatrixD operator +(FxMatrixD mat, float value)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        }

        public static FxMatrixD operator +(FxMatrixD mat, double value)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        ...
        public static FxMatrixD operator +(float value, FxMatrixD mat)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        ...
        public static FxMatrixD operator +(double value, FxMatrixD mat)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        ...
        public static FxMatrixD operator +(FxMatrixD mat, int value)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        ...
        public static FxMatrixD operator +(int value, FxMatrixD mat)
        {
            var newMat = mat.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(value);
            return newMat;
        ...
        public static FxMatrixD operator +(FxMatrixD mat1, FxMatrixD mat2)
        {
            var newMat = mat1.AllocateCopyMatrix() as FxMatrixD;
            newMat.DoAdd(mat2);
            return newMat;
        }
        #endregion
        ...
        protected override void DoSubtract( FxMatrix<double> other, FxMatrix<double> result )
        {
        ...
        protected override void DoSubtract( FxMatrix<double> other )
        {
            // pass all the data and Subtract the new data
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected override void DoSubtractRow(FxMaths.Vector.FxVector<double> Row, int RowIndex)
        {
            // set the offset for the specific row
            int rowOffset = RowIndex * Width;
        ...
        protected override void DoSubtractCol(FxMaths.Vector.FxVector<double> Col, int ColIndex)
        {
            // pass all the data and Subtract the value
            for ( int i=0; i < Height; i++ ) {
                Data[i * Width + ColIndex] -= Col[i];
        ...
        protected override void DoMultiply(FxMatrix<double> other, FxMatrix<double> result)
        {
            #region test code
            /*
            ...
            unsafe
            {
                ...
                Parallel.For(0, OWidth, (x) =>
                {
                    ...
                    FxMaths.Vector.FxVector<double> vec = other.GetCol(x);
                    double sum = 0.0f;
                    int Width2 = Width - Width % 2;

                    // use pointer to access the data
                    fixed (double* DataX = Data)
                    {
                        fixed (double* ResultX = result.Data)
                        {

                            // get the pointer of the result and the local data
                            double* pData = DataX;
                            double* pResult = ResultX + x;
        ...
        protected override void DoMultiply(FxMaths.Vector.FxVector<double> rightSide, FxMaths.Vector.FxVector<double> result)
        {
            // pass all the data and Multiply the new data
            Parallel.For( 0, Height, ( y ) => {
        ...
        protected override void DoLeftMultiply(FxMaths.Vector.FxVector<double> leftSide, FxMaths.Vector.FxVector<double> result)
        {
            // pass all the data and Multiply the new data
        ...
        #region Pointwise
        protected override void DoMultiplyPointwise( FxMatrix<double> other, FxMatrix<double> result )
        {
            // pass all the data and Multiply the value
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected override void DoMultiplyPointwise( FxMatrix<double> other )
        {
            // pass all the data and Multiply the value
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected override void DoDividePointwise( FxMatrix<double> other, FxMatrix<double> result )
        {
            // pass all the data and Divide the value
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        protected override void DoDividePointwise( FxMatrix<double> other )
        {
            // pass all the data and Divide the value
            Parallel.For( 0, Height, ( y ) => {
                int offsetEnd = ( y + 1 ) * Width;
        ...
        {
            double mean = Mean();
            FxMaths.Vector.FxVectorD RowResult = new Vector.FxVectorD(Height, 0);
        ...
        public override double Norm( NormMatrixType type )
        {
            double value = 0;
        ...
        public override Vector.FxVectorI LU()
        {
            ...
            var vecLUcolx = new double[order];
        ...
        public override double Determinal()
        {
            if (Width != Height)
                return 0;
        ...
        public override FxMatrix<double> Inverse()
        {
            // check if we can compute inverse
            double det = this.Determinal();
            if (det == 0) 
                return null;

            // create the result matrix
            FxMatrix<double> result = this.AllocateMatrix(Width, Height);
            switch (Width)
            {
                case 1:
                    result[0] = 1 / Data[0];
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public override double Sample(float x, float y)
        {
            // for now we are support only Bilinear sampling
            int lowX = (int)Math.Floor(x);
            int lowY = (int)Math.Floor(y);
            double lowlow = this[lowX, lowY];
            double lowhi = this[lowX, lowY + 1];
            double hilow = this[lowX + 1, lowY];
            double hihi = this[lowX + 1, lowY + 1];
            x=x-lowX;
            y=y-lowY;
        ...
        public static FxMatrixMask operator >(FxMatrixD mat1, FxMatrixD mat2)
        {
        ...
        #region With Double scalar

        public static FxMatrixMask operator >(FxMatrixD mat1, double value) { return FxMatrixMask.GreaderThan<double>(mat1, value); }
        public static FxMatrixMask operator <(FxMatrixD mat1, double value) { return FxMatrixMask.LessThan<double>(mat1, value); }
        public static FxMatrixMask operator ==(FxMatrixD mat1, double value) { return FxMatrixMask.Equal<double>(mat1, value); }
        public static FxMatrixMask operator !=(FxMatrixD mat1, double value) { return FxMatrixMask.NotEqual<double>(mat1, value); }
        ...
        public static FxMatrixMask operator >(FxMatrixD mat1, float value) { return FxMatrixMask.GreaderThan<float>(mat1, value); }
        public static FxMatrixMask operator <(FxMatrixD mat1, float value) { return FxMatrixMask.LessThan<float>(mat1, value); }
        public static FxMatrixMask operator ==(FxMatrixD mat1, float value) { return FxMatrixMask.Equal<float>(mat1, value); }
        public static FxMatrixMask operator !=(FxMatrixD mat1, float value) { return FxMatrixMask.NotEqual<float>(mat1, value); }
        ...
        public static FxMatrixMask operator >(FxMatrixD mat1, int value) { return FxMatrixMask.GreaderThan<int>(mat1, value); }
        public static FxMatrixMask operator <(FxMatrixD mat1, int value) { return FxMatrixMask.LessThan<int>(mat1, value); }
        public static FxMatrixMask operator ==(FxMatrixD mat1, int value) { return FxMatrixMask.Equal<int>(mat1, value); }
        public static FxMatrixMask operator !=(FxMatrixD mat1, int value) { return FxMatrixMask.NotEqual<int>(mat1, value); }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is FxMatrixD)
            {
                FxMatrixD mat = obj as FxMatrixD;
                Boolean equal = true;
                for (int i = 0; i < Size; i++)
        ...
        /// <returns></returns>
        public FxMatrixD Gradient(GradientMethod method)
        {
            var result = new FxMatrixD(Width, Height);
        ...
        public void Clamp(double min, double max, double minReplace = 0)
        {
            // pass all the data and add the new data
            Parallel.For(0, Height, (y) => {
                int offsetEnd = (y + 1) * Width;
        ...
        public FxMatrixD Resize(int width, int height)
        {
            var newMat = new FxMatrixD(width, height);
        ...
        public FxMatrixD MedianFilt(int sx = 3, int sy = 3)
        {
            FxMatrixD result = new FxMatrixD(Width, Height);
            ...
            Parallel.For(0, Height, (y) =>
            {
                ...
                FxMaths.Vector.FxVectorD vec = new Vector.FxVectorD(sx * sy);
                for (int x = 0; x < Width; x++)
                {
